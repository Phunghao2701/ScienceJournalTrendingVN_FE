...
function AuthorWorksChart({ data }) {
  ...
  if (!data || data.length === 0) {
    return (
      <div
        className="d-flex align-items-center justify-content-center h-100 text-muted-custom"
    ...
    <svg viewBox={`0 0 ${W} ${H}`} width="100%" height="100%">
        ...
        return (
          <g>
            ...
            {data.map((d, i) => {
              ...
              const cy =
                PAD.top + chartH - (d.citations / maxCitations) * chartH;
              return (
                <circle
                  key={i}
                  cx={cx}
      ...
      {(() => {
        ...
        if (indices[indices.length - 1] !== lastIndex) {
          ...
          if (lastIndex - indices[indices.length - 1] < labelStep)
            indices.pop();
...
export default function AuthorDetailPage() {
  ...
  const yearsData = useMemo(() => {
    ...
    authorArticles.forEach((art) => {
      ...
      if (y) {
        ...
        const citCount =
          art.citation_count ?? art.cited_by_count ?? art.citations ?? 0;
    ...
    authorArticles.forEach((art) => {
      if (Array.isArray(art.authors)) {
        art.authors.forEach((au) => {
          ...
          if (
            auName &&
            auName !== currentAuthor?.full_name &&
            auName !== currentAuthor?.name
          ) {
            allCoauthors[auName] = {
              id: auId,
              name: auName,
  ...
  const sortedArticles = useMemo(() => {
    ...
    if (sortKey === "year-desc") {
      return list.sort(
        (a, b) =>
          (b.publication_year || b.year || 0) -
          (a.publication_year || a.year || 0),
      );
    }
    if (sortKey === "year-asc") {
      return list.sort(
      ...
      <Container fluid className="position-relative z-1 px-3 px-xl-5 pt-4">
        ...
        {loadingAuthorDetail ? (
          <div className="lens-author-profile-header-card p-4 mb-4 text-center">
            <div
              className="skeleton-shimmer rounded-circle mx-auto mb-3"
              style={{ width: "80px", height: "80px" }}
            />
            <div
              className="skeleton-shimmer rounded mx-auto mb-2"
              style={{ width: "200px", height: "24px" }}
            />
            <div
              className="skeleton-shimmer rounded mx-auto"
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="d-flex align-items-center mb-1 flex-wrap gap-2">
                      <h2 className="lens-author-name mb-0 text-truncate">
                        {authorName}
                      </h2>
                ...
                <div className="d-flex align-items-center gap-4">
                  ...
                  <div className="lens-stat-box-large">
                    ...
                    <div>
                      <div className="stat-value">
                        {(
                          currentAuthor?.citation_count ??
                          currentAuthor?.citations ??
                          0
                        ).toLocaleString()}
                      </div>
                ...
                <Card className="lens-detail-card h-100">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex flex-column gap-3 font-sans text-xs">
                      <div>
                        <div
                          className="text-muted-custom fw-bold text-uppercase mb-1"
              ...
              <Col xs={12} lg={4}>
                <Card className="lens-detail-card h-100">
                  ...
                  <Card.Body className="p-3">
                    {loadingAreas ? (
                      <div
                        className="skeleton-shimmer rounded w-100 h-100"
                          ...
                          return (
                            <div key={index} className="text-xs">
                              <div className="d-flex justify-content-between mb-1">
                                <span
                                  className="text-dark fw-semibold text-truncate me-2"
                                  style={{ maxWidth: "80%" }}
                                >
                                  {name}
                                </span>
                    ...
                    ) : currentAuthor?.subject_areas &&
                      currentAuthor.subject_areas.length > 0 ? (
                      ...
                      <div className="d-flex flex-column gap-3">
                        {sortedArticles.map((article, idx) => {
                          ...
                          return (
                            <div
                              key={artId || idx}
                              className="lens-article-card-item"
                            >
                              <div className="d-flex align-items-start gap-1">
                                ...
                                <div className="flex-grow-1 min-w-0">
                                  ...
                                  <div className="d-flex gap-2 flex-wrap mb-2">
                                    ...
                                    <span
                                      className={`lens-ext-badge text-uppercase text-2xs ${isOpenAccess ? "open" : "restricted"}`}
                                    >
                                      <Icon
                                        icon={
                                          isOpenAccess
                                  ...
                                  {/* Citation metrics */}
                                  <div className="lens-article-card-detail-line text-xs font-sans">
                                    Citing Patents: <strong>0</strong> | Citing
                                    Scholarly Works:{" "}
                                    ...
                                    | Reference Count:{" "}
                                    <strong>
                                      {article.reference_count ?? 19}
                                    </strong>
                                    {doi && (
                                      <>
                                        {" | "}
                                        <strong>DOI:</strong>{" "}
                                        <span className="font-monospace text-xs text-dark">
                                          {doi}
                                        </span>
                                      </>
                                    )}
                                  ...
                                  <Collapse in={isExpanded}>
                                    <div
                                      className="mt-2 p-3 bg-light rounded text-xs text-muted-custom font-sans"
                                      style={{
                          ...
                          <div key={idx} className="col-12 col-md-6 col-lg-4">
                            ...
                            >
                              <div className="d-flex align-items-center gap-2 mb-2">
                                ...
                                <div className="min-w-0">
                                  <h6 className="mb-0 text-truncate text-dark fw-bold text-xs">
                                    {co.name}
                                  </h6>
