...
export default function JournalHero({
  ...
  if (loading || !journal) {
    return (
      <section
        className="journal-surface journal-hero-card mb-4"
        aria-label="Đang tải thông tin tạp chí"
      >
        <Row className="gy-4 journal-hero-content">
          ...
          <Col lg={4} className="text-lg-end">
            <div
              className="skeleton-shimmer mb-2 ms-lg-auto"
              style={{ width: "150px", height: "72px" }}
            />
            <div
              className="skeleton-shimmer mb-3 ms-lg-auto"
              style={{ width: "160px", height: "20px" }}
            />
            <div className="d-flex gap-2 justify-content-lg-end flex-wrap">
              <div
                className="skeleton-shimmer"
                style={{ width: "110px", height: "38px", borderRadius: "6px" }}
              />
              <div
                className="skeleton-shimmer"
                style={{ width: "140px", height: "38px", borderRadius: "6px" }}
              />
            </div>
          </Col>
        </Row>
  ...
  const quartileClass =
    quartile === "Q1"
      ? "journal-badge--q1"
      : quartile === "Q2"
        ? "journal-badge--accent"
        : "journal-badge--neutral";
      ...
      <Row className="gy-4 align-items-start journal-hero-content">
        <Col lg={8} md={7}>
          ...
          <p className="journal-description">
            {description ||
              "Chưa có mô tả chi tiết phạm vi nghiên cứu cho tạp chí này."}
          </p>

          {subject_categories.length > 0 && (
            <div
              className="journal-category-list"
            ...
            >
              {subject_categories.map((cat, idx) => (
                <span
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && handleCategoryClick(cat.display_name)
                  }
        ...
        <Col lg={4} md={5} className="text-md-end text-start mt-lg-2">
          {metric_value ? (
            <div className="journal-metric-panel ms-md-auto mb-3">
              <div className="journal-metric-value">{metric_value}</div>
